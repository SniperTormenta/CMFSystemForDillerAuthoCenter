...
namespace CMFSystemForDillerAuthoCenter.Windows
{
    public partial class NewDealsWindow : Window
    {
        ...
        public NewDealsWindow(CarData carData, ClientStorage clientStorage, EmployeeStorage employeeStorage = null, EmailService emailService = null)
        {
            ...
            //System.Diagnostics.Debug.WriteLine($"NewDealsWindow: _clientStorage содержит {_clientStorage?.Clients?.Count ?? 0} клиентов (из конструктора).");
            InitializeVariants();
            SetInitialView();
        }
        ...
        public NewDealsWindow()
        {
            ...
            //System.Diagnostics.Debug.WriteLine($"NewDealsWindow (default): _clientStorage содержит {_clientStorage?.Clients?.Count ?? 0} клиентов (из конструктора).");
            InitializeVariants();
            SetInitialView();
        }
